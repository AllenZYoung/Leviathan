# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-12-11 03:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Evaluation',
            fields=[
                ('id_evaluation', models.AutoField(max_length=11, primary_key=True, serialize=False)),
                ('level', models.IntegerField(blank=True, help_text='\u533b\u751f\u8bc4\u4ef7\u7b49\u7ea7', null=True)),
                ('comment', models.TextField(blank=True, default='\u6682\u65e0\u8bc4\u4ef7\u4fe1\u606f', help_text='\u533b\u751f\u8bc4\u4ef7', null=True)),
                ('createtime', models.DateTimeField(help_text='\u8bc4\u4ef7\u6210\u65f6\u95f4')),
        ...
        migrations.AddField(
            ...
            name='patient',
            field=models.ForeignKey(db_column='patient', on_delete=django.db.models.deletion.CASCADE, to='users.Patient'),
        ),
        migrations.AddField(
